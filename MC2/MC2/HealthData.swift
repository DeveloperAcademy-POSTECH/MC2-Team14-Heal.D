...
struct HealthData {
    ...
    init(healthStore: HKHealthStore? = nil, todayStepCount: Double = 0.0, todayActiveEnergy: Double = 0.0, todayExerciseTime: Double = 0.0) {
        HealthAuth()
        
        self.healthStore = healthStore
        self.todayStepCount = todayStepCount
        self.todayActiveEnergy = todayActiveEnergy
        self.todayExerciseTime = todayExerciseTime
    }
}
